...
const register = async (req, res) => {
  ...
  const verifyEmail = {
    to: email,
    html: `<html><a target="_blank" href='${BASE_URL}/api/auth/verify/${verificationToken}'>Click to verify your email</a></html>`,
  };
...
const updateSubscription = async (req, res) => {
  ...
  res.status(200).json({
    message: `You change your subscription to ${updatedSubscription.subscription}`,
  });
};
